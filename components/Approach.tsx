        ...
        <section className="w-full py-20">
            ...
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
                <Card
                    ...
                    description="We'll start by collaborating on a plan that aligns with your goals and objectives. We'll also discuss the strategy that will help us achieve those goals. This phase will help us understand your business requirements and how we can help you achieve them."
                >
                    <CanvasRevealEffect
                        animationSpeed={5.1}
                ...
                <Card
                    ...
                    description="Once we have a plan in place, we'll start developing your project. We'll keep you updated on our progress and make sure that we're on the right track. We'll also make sure that you're happy with the work we're doing and that it meets your expectations."
                    >
                    <CanvasRevealEffect
                        animationSpeed={3}
                ...
                <Card
                    ...
                    description="Once we've completed the development phase, we'll launch your project. We'll make sure that everything is working as expected and that you're happy with the final product. We'll also provide you with any support you need to ensure that your project is a success."
                    >
                    <CanvasRevealEffect
                        animationSpeed={3}
